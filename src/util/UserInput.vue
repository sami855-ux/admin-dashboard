...
<template>
  <div class="w-full h-fit flex flex-col justify-center py-4">
    <section class="w-[100%] py-1 flex flex-col">
      <label for="name" class="py-2 text-[14px]">username</label>
      <input
        type="text"
        name="name"
    ...
    <section class="w-[100%] py-1 flex flex-col">
      <label for="code" class="py-2 text-[14px]">Mobile Phone</label>
      <input
        type="tel"
        name="code"
        class="border border-custom text-[14px] outline-none py-1 rounded-md px-2 active:border-blue-500 focus:border-blue-500 transition ease-in"
    ...
    <section class="w-[100%] py-1 flex flex-col">
      <label for="code" class="py-2 text-[14px]">Email</label>
      <input
        type="email"
        name="code"
        class="border border-custom text-[14px] outline-none py-1 rounded-md px-2 active:border-blue-500 focus:border-blue-500 transition ease-in"
    ...
    <section class="w-[100%] py-1 flex flex-col">
      <label for="code" class="py-2 text-[14px]">Role</label>
      <input
        type="text"
        name="code"
        class="border border-custom text-[14px] outline-none py-1 rounded-md px-2 active:border-blue-500 focus:border-blue-500 transition ease-in"
