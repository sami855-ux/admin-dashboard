...
<template>
  <div class="w-full h-fit flex flex-col justify-center py-4">
    <section class="w-[100%] py-1 flex flex-col">
      <label for="name" class="py-2">Data Created</label>
      <input
        type="date"
        name="name"
    ...
    <section class="w-[100%] py-1 flex flex-col">
      <label for="code" class="py-2">Created by</label>
      <input
        type="text"
        name="code"
        class="border border-gray-200 outline-none py-1 rounded-md px-2 active:border-blue-500 focus:border-blue-500 transition ease-in"
    ...
    <section class="w-[100%] py-1 flex flex-col">
      <label for="code" class="py-2">Backup File Name</label>
      <input
        type="text"
        name="code"
        class="border border-gray-200 outline-none py-1 rounded-md px-2 active:border-blue-500 focus:border-blue-500 transition ease-in"
    ...
    <section class="w-[100%] py-1 flex flex-col">
      <label for="code" class="py-2">File Size</label>
      <input
        type="text"
        name="code"
        class="border border-gray-200 outline-none py-1 rounded-md px-2 active:border-blue-500 focus:border-blue-500 transition ease-in"
    ...
    <section class="w-[100%] py-1 flex flex-col">
      <label for="code" class="py-2">Backup Type</label>
      <input
        type="text"
        name="code"
        class="border border-gray-200 outline-none py-1 rounded-md px-2 active:border-blue-500 focus:border-blue-500 transition ease-in"
