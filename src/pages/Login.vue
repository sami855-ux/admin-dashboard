...
import { isValidEmail } from "../util/helper.js"
...
const handleSubmit = () => {
  if (!state.email || !state.password) {
    state.errormsg = "Fields can not be blank"
    return
  }
  ...
  >
    ...
    >
      ...
      <div class="title_container">
        <p class="title">
          Hi there, good to see <br />
          you back!
        </p>
        <span class="subtitle"
          >Login into your account to the website and start <br />
      ...
      <button title="Sign In" class="sign-in_ggl" @click="handleGoogleSubmit">
        <svg
          height="18"
          width="18"
          viewBox="0 0 32 32"
      ...
      <p class="note">Designed &amp; developed by Melfan tech.</p>
    </form>
  </div>
</template>
...
<style scoped>
.wrapper {
  background-image: url("../assets/colorfulBackg.png");
...
.sign-in_btn {
  ...
  height: 40px;
  border: 0;
  background: linear-gradient(to right, rgb(214, 57, 57), rgb(223, 176, 88));
  border-radius: 7px;
  outline: none;
  color: #ffffff;
  cursor: pointer;
