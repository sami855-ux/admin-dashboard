...
<template>
  <div class="w-full h-fit">
    ...
    <div class="w-full h-10 flex justify-between items-center pr-16 mt-5">
      <p class="text-semibold text-lg py-4">Dashboard - Employee List</p>

      <button
        class="px-7 py-1 text-gray-100 bg-blue-400 border border-blue-200 rounded-md cursor-pointer"
        @click="handleModal"
      >
        Create Employee +
      </button>
    ...
    <div
      ...
      } w-[600px] h-screen fixed top-0  z-50 bg-white p-8 border border-gray-100  transition duration-500 ease-in-out overflow-scroll`"
    >
