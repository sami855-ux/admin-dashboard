...
<template>
  <div class="w-full h-fit">
    <div class="w-fit h-10 flex items-center gap-3">
      ...
      <p class="text-semibold text-[16px] py-4">Dashboard - Customer List</p>
    </div>
    ...
    <div class="w-full h-fit">
      ...
      >
        ...
        <div class="h-full w-fit pl-16 lg:pl-0 lg:ml-5">
    ...
    <div
      ...
      } w-[400px] lg:w-[600px] h-screen fixed top-0  z-100 bg-color py-5 px-10 border border-custom  transition duration-500 ease-in-out overflow-scroll`"
    >
    ...
    <div
      ...
      } w-[600px] hidden md:flex h-screen fixed top-0  z-100 bg-color py-5 px-4 border border-custom  transition duration-500 ease-in-out overflow-scroll`"
    >
      <i
