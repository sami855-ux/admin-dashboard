...
const updateScreenWidth = () => {
  ...
  console.log("isLargeScreen:", state.isLargeScreen)
}
...
<template>
  <div
    :class="`${
      state.isLargeScreen ? 'w-[240px] bg-[#fabdb4] ' : 'w-20'
  ...
  >
    ...
    <div
      ...
      } fixed z-50 w-[240px] h-screen flex-col items-center py-2 transition-all duration-500 ease-in-out `"
    >
      <i
      ...
      >
        ...
        <div class="">
          <h2 class="font-bold text-gray-800 pt-1 text-[15px]">Mo Spa</h2>
          <p class="text-[12px] text-gray-700 flex">Admin dashboard</p>
        </div>
      </div>
      <div :class="`w-full max-h-[75vh] px-4 mt-8 overflow-scroll`">
        <p class="text-gray-600 text-[13px] flex">Main-menu</p>
        ...
        <ul class="w-full h-fit flex flex-col pl-1 space-y-1">
          ...
          >
            <div class="w-fit h-full flex items-center space-x-2.5">
              ...
              <p class="text-gray-900 pt-1 flex text-[13px]">Transaction</p>
            </div>
            <span class="flex">
              <i
                :class="`hidden pi ${
                  !state.transactionBtn ? 'pi-angle-right' : 'pi-angle-down'
                }   text-gray-800 pt-1 cursor-pointer mr-2 `"
              ></i>
            </span>
          </li>
          ...
          <div
            ...
            class="w-full h-fit bg-slate-300 md:px-5"
            @click="
              () => {
          ...
          >
            <ul class="w-full h-fit flex flex-col my-1 pl-2">
              <RouterLink
                ...
                to="/admin/pending"
              >
                <p class="text-gray-900 text-[13px]">Pending Transaction</p>
              </RouterLink>
              <RouterLink
                class="link flex items-center space-x-2 relative"
                to="/admin/completed"
                @click="handleClick"
              >
                <p class="text-gray-900 text-[13px]">Completed Transaction</p>
              </RouterLink>
            </ul>
          </div>
          <li
          ...
          >
            <div class="w-fit h-full flex items-center space-x-2.5">
              ...
              <p class="text-gray-900 text-[13px] pt-1 flex">Registration</p>
            </div>
          ...
          >
            <ul class="w-full h-fit flex flex-col items-center my-1 pl-2">
              <RouterLink
                ...
                @click="handleClick"
              >
                <p class="text-gray-900 pt-1 text-[13px]">Employee List</p>
              </RouterLink>
              <RouterLink
                ...
                @click="handleClick"
              >
                <p class="text-gray-900 pt-1 text-[13px]">Customer List</p>
              </RouterLink>
              <RouterLink
                class="link flex items-center space-x-2.5 relative"
                to="/admin/service"
                @click="handleClick"
              >
                <p class="text-gray-900 pt-1 text-[13px]">Service List</p>
              </RouterLink>
              <RouterLink
                class="link flex items-center space-x-2.5 relative"
                to="/admin/catagory"
                @click="handleClick"
              >
                <p class="text-gray-900 pt-1 text-[13px]">Category List</p>
              </RouterLink>
            </ul>
          </div>
...
.link.router-link-exact-active::after {
  ...
  background: linear-gradient(to bottom, rgb(240, 156, 61), rgb(226, 16, 16));
}
